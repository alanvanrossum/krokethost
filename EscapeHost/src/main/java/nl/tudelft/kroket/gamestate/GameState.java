...
public class GameState {
     ...
     * 
     * @param stateClass
     *            the class it needs to change to
     */
    ...
    /**
     * Matches the action from the input to all possible strings. The
     * appropriate method call is executed.
     * 
     * @param input
    ...
    /**
     * Methods that can be overwritten with functionality in the subclasses of
     * GameState. A certain method should only have functionality/be executed if
     * the game is in the right game state.
     * 
     * @param input
     *            the input string received from the client
     * @param parsedInput
